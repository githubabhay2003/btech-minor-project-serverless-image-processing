...
![Frontend Selected](./screenshots/2_frontend_selected.png)
This screenshot displays the frontend after an image file has been selected by the user. The original image preview is shown along with options to upload the image for processing.

### 3. Image Upload Status and Processed Image Links
![Upload Status](./screenshots/3_upload_status.png)
This screenshot shows the frontend status message after a successful upload. It also provides links to the resized image and thumbnail image generated by the system.

### 4. Amazon S3 Bucket List
![S3 Bucket List](./screenshots/4_s3_bucket_list.png)
...
### 5. Input Storage Bucket with Uploaded Image
![Input Bucket](./screenshots/5_input_bucket.png)
This screenshot shows the input S3 bucket containing the original image uploaded by the user before processing.

### 6. Output Storage Bucket Structure
![Output Bucket](./screenshots/6_output_bucket.png)
This screenshot displays the output S3 bucket structure with separate folders for resized images and thumbnail images.

### 7. CloudWatch Log Group for Image Processing Lambda Function
![CloudWatch Log Group](./screenshots/7_cloudwatch_group.png)
...
### 8. CloudWatch Log Streams Generated During Image Upload Events
![CloudWatch Log Streams](./screenshots/8_cloudwatch_streams.png)
This screenshot displays multiple log streams created when image upload events trigger the Lambda function.

### 9. CloudWatch Log Events Showing Image Processing Details
![Processing Details](./screenshots/9_log_details.png)
...
### 10. Terraform Apply Output – Infrastructure Provisioning
![Terraform Output](./screenshots/10_terraform_apply.png)
